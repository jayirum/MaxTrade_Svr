...
void CSender::threadFunc_send_to_clients()
{
    __try
    {
        threadFunc_send_to_clients_Internal();
    }
    __except (EXCEPTION_EXECUTE_HANDLER)
    {
        gCommon.log(ERR, FALSE, "---------------------------------------------------");
        gCommon.log(ERR, TRUE, "unexpected exception in CSender::threadFunc_send_to_clients");
        gCommon.log(ERR, FALSE, "---------------------------------------------------");
    }
...
// Worker 실행 함수
void CSender::threadFunc_send_to_clients_Internal()
{

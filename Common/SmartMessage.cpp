...
{
	//*pValue = (_FBI::TFutExec2 * )SMMessageGetBinaryFieldValue(m_lIdx, RECEIVED_MESSAGE, pFieldName);
	*pValue = SMMessageGetBinaryFieldValue(m_lIdx, RECEIVED_MESSAGE, pFieldName);
	if (!*pValue)
	{

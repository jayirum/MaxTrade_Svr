...
#include "./Header/CSPAT00600.h"
#include "./Header/CSPAT00700.h"
#include "./Header/CSPAT00800.h"
#include "./Header/CSPAQ03700.h"
#include "./Header/CSPAQ02300.h"
#include "./Header/SC0.h"
#include "./Header/SC1.h"
#include "./Header/SC2.h"
#include "./Header/SC3.h"
#include "./Header/SC4.h"
#include "./Header/S3_.h"
#include "./Header/H1_.h"
#include "./Header/K3_.h"
#include "./Header/HA_.h"
...
LRESULT CSample_xingACEDlg::OnXMReceiveData( WPARAM wParam, LPARAM lParam )
{
	if( wParam == REQUEST_DATA )
	{
		LPRECV_PACKET pPacket = (LPRECV_PACKET)lParam;
			 if( strcmp( pPacket->szTrCode, "CSPAT00600" ) == 0 ) ReceiveCSPAT00600( pPacket->lpData, pPacket->nDataLength );

...
typedef struct _OVH_OutBlock
{
    ...
    char    offerho1[15];    char    _offerho1;    // [double, 15.9] 매도호가 1                      StartPos 16, Length 15
    char    bidho1[15];    char    _bidho1;    // [double, 15.9] 매수호가 1                      StartPos 32, Length 15
    ...
    char    offerho2[15];    char    _offerho2;    // [double, 15.9] 매도호가 2                      StartPos 92, Length 15
    char    bidho2[15];    char    _bidho2;    // [double, 15.9] 매수호가 2                      StartPos 108, Length 15
    ...
    char    offerho3[15];    char    _offerho3;    // [double, 15.9] 매도호가 3                      StartPos 168, Length 15
    char    bidho3[15];    char    _bidho3;    // [double, 15.9] 매수호가 3                      StartPos 184, Length 15
    ...
    char    offerho4[15];    char    _offerho4;    // [double, 15.9] 매도호가 4                      StartPos 244, Length 15
    char    bidho4[15];    char    _bidho4;    // [double, 15.9] 매수호가 4                      StartPos 260, Length 15
    ...
    char    offerho5[15];    char    _offerho5;    // [double, 15.9] 매도호가 5                      StartPos 320, Length 15
    char    bidho5[15];    char    _bidho5;    // [double, 15.9] 매수호가 5                      StartPos 336, Length 15
